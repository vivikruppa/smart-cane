...
# Edge Impulse library for OD_ESP32S3_Only_Sign v1

This is a C++ library that lets you run the impulse for "OD_ESP32S3_Only_Sign v1" (https://studio.edgeimpulse.com/studio/954575) on any device. It consists of the Edge Impulse inferencing SDK - with implementations of both processing and learning blocks - and your model. You will need to include this library in your project to run your impulse locally.
